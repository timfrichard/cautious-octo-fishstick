package com.gift3dconc3pts.spring_batch_upload_tas_betc_api.core.model.entities;
...
public class TasBetc {
    ...
    @Column(name = "FK_FILE_UPLOAD_JOB_HEADER_ID")
    private Long fileUploadJobHeader;
